  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-10">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
        {/* About Section */}
        <div>
          <h3 className="text-xl font-semibold mb-4 text-white">CollegeBooking</h3>
          <p className="text-sm leading-relaxed">
            Discover and book your favorite colleges easily.  
            Stay updated with admissions, events, and latest research.
          </p>
        </div>
